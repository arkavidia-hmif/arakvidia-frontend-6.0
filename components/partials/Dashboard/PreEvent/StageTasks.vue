...
import PreEventActionWidget from '~/components/partials/Dashboard/PreEvent/PreEventActionWidget.vue';

@Component({
  components: { PreEventActionWidget, Alert }
})
