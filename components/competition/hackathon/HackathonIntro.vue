				...
				<v-row wrap>
					<v-col :cols="12" :md="7" align-self="center">
						...
						<div class="mt-8 caption">
							Kategori
							&nbsp;
							<v-chip small color="black" class="black white--text caption">Mahasiswa</v-chip>
						</div>
						<div class="mt-8">
							<v-btn large rounded outlined color="#0B909A" class="text-none mr-2 mt-2">Download guidebook</v-btn>
							<v-btn large rounded color="primary" class="text-none mt-2" elevation="0">Daftar sekarang</v-btn>
						</div>
					</v-col>
					<v-col :cols="12" :lg="3" :offset-lg="2" :md="4" :offset-md="1" align="center" class="hidden-sm-and-down"
								 align-self="center">
