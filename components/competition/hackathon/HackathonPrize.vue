<template>
	<v-container px-4 no-gutter>
		<div class="headline font-weight-bold">Hadiah Pemenang</div>
		<div>
			<v-row class="mt-4">
				<v-col :cols="12" :sm="4">
					<v-responsive :aspect-ratio="2" class="white--text pa-0 ma-0" style="background: #FF084F">
			...
			<v-row>
				...
				<v-col :cols="12" :sm="4">
					<v-responsive :aspect-ratio="2" class="white--text pa-0 ma-0" style="background: #0578D3">
						<v-container fill-height class="pa-0" justify-content-center>
							<div style="width: 100%" align="center">
			...
			<v-row>
				...
				<v-col :cols="12" :sm="4">
					<v-responsive :aspect-ratio="2" class="white--text pa-0 ma-0" style="background: #7608FF">
						<v-container fill-height class="pa-0" justify-content-center>
							<div style="width: 100%" align="center">
			...
			<v-row>
				<v-col :cols="12" :sm="6">
					<v-responsive :aspect-ratio="3" class="white--text pa-0 ma-0">
