<template>
    <v-container fluid fill-height justify-space-between align-start column class="pa-0 ma-0"
                        ...
                        <v-flex md6 class="px-4">
                            <v-layout align-start column fill-height>
                                ...
                                <v-flex>
                                    ...
                                    <div class="mt-3">
                                        <a href="https://www.instagram.com/arkavidia" target="_blank"
                                           style="text-decoration: none">
                                            <v-icon color="#1D7AA2">fab fa-instagram</v-icon>
                                        </a>
                                        &nbsp;
                                        <a href="https://line.me/R/ti/p/%40aab5143y" target="_blank"
                                           style="text-decoration: none">
